...
const BillProduct = ({ show, handleClose, shopDet, custName,custMobile,custAddr,custPincode,custEmail,custGstNo, invDate, invoiceNo }) => {
            ...
            <Modal.Body>
                <Form>
                    <Form.Group>
                            ...
                            >
                                ...
                                {products.map((name) => (
                                    <option key={name._id} value={name.productName}
                                             ...
                                             data-productUnitPrice={name.productUnitPrice}
                                             data-productDesc={name.productDesc}
                                             data-productGstPrice={name.productGstPrice} >
                                        {name.productName}
                        ...
                        <div className='row mb-2'>
                        <div className="input-group col-md-2">
                        <span class="input-group-text">Product GST %:</span>
                        <input
                        type="text"
                        ...
                        style={{ textAlign: 'right' }}
                        />
                         <span class="input-group-text">Total Bill Value:</span>
                        <input
                        type="text"
                        value={totalAmount}
